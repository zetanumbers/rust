...
pub use rustc_query_system::dep_graph::{
    DepCache, DepContext, DepGraphQuery, DepNodeIndex, Deps, SerializedDepGraph,
    SerializedDepNodeIndex, TaskDepsRef, TimedDepNode, WorkProduct, WorkProductId, WorkProductMap,
    hash_result,
};
