...
macro_rules! arena_types {
    ($macro:path) => (
        $macro!([
            ...
            [decode] crate_source: std::sync::Arc<rustc_session::cstore::CrateSource>,
            [decode] dependencies: std::sync::Arc<rustc_middle::middle::dependency_format::Dependencies>,
            [decode] output_filenames: std::sync::Arc<rustc_session::config::OutputFilenames>,
            [decode] map_symbol_symbol: rustc_data_structures::unord::UnordMap<rustc_span::Symbol, rustc_span::Symbol>,
            [] map_string_stability: rustc_data_structures::unord::UnordMap<std::string::String, rustc_target::target_features::Stability>,
            [] lint_id_set: rustc_data_structures::unord::UnordSet<rustc_lint_defs::LintId>,
