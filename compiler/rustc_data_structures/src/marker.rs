...
impl_dyn_sync!(
    ...
    [measured_parking_lot::lock_api::Mutex<R, T> where R: DynSync, T: ?Sized + DynSend]
    [measured_parking_lot::lock_api::RwLock<R, T> where R: DynSync, T: ?Sized + DynSend + DynSync]
